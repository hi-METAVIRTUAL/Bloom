...
public class SelectCriteria {
    ...
    public SelectCriteria(int pageNo, int totalBoardCount, int limitPerPage, int buttonAmount, int lastPage, int startPage, int endPage, int startRow, int endRow, String searchSelect, String searchValue) {
        this.pageNo = pageNo;
