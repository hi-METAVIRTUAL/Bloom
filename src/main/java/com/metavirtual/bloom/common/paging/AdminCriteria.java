...
public class AdminCriteria {
    ...
    /* 검색 창 */
    private String searchSelect; // 검색조건 옵션 (아이디, 이름)
    private String searchValue; // 검색 텍스트

    public AdminCriteria() {
    }

    public AdminCriteria(int pageNo, int totalBoardCount, int limitPerPage, int buttonAmount, int lastPage, int startPage, int endPage, int startRow, int endRow, String searchSelect, String searchValue) {
        this.pageNo = pageNo;
